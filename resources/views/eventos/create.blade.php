...
@section('content')
    ...
    <div class="card mt-24">
        <div class="card-header border-bottom">
            <h4 class="mb-4">Evento</h4>
            <p class="text-gray-600 text-15">Datos generales</p>
        </div>
        <div class="card-body">
            <form action="{{ route('eventos.store') }}" method="POST">
                ...
                <div class="row gy-4">
                    <div class="col-sm-6 col-xs-6">
                        ...
                        <input type="text" class="form-control py-11 @error('nombre') border-danger @enderror" id="nombre"
                    ...
                    <div class="col-sm-6 col-xs-6">
                        ...
                        <input type="text" class="form-control py-11" id="descripcion" name="descripcion" placeholder="">
                        @error('descripcion')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-sm-6 col-xs-6">
                        ...
                        <input type="date" class="form-control py-11" id="fecha" name="fecha" placeholder="" >
                        @error('fecha')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12">
                        <div class="flex-align justify-content-start gap-8">
                            ...
                            <button type="submit" class="btn btn-primary text-sm btn-sm px-24 rounded-pill py-12 gap-2">Guardar</button>
                        </div>
                    </div>
                </div>
            </form>
