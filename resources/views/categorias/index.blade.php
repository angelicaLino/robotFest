    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        ...
        <div class="breadcrumb mb-24">
            <ul class="flex-align gap-4">
                ...
                <li><span class="text-main-600 fw-normal text-15">Categorias</span></li>
            </ul>
        </div>
        <!-- Breadcrumb End -->
            ...
            <table id="dataTable" class="table table-striped align-middle mb-0 mt-5">
                ...
                <tbody>
                    @foreach ($categorias as $categoria)
                        <tr>
                            <td>
                                <span class="h6 mb-0 fw-medium text-gray-300">{{ $categoria->id }}</span>
                            </td>
                            <td>
                                <div class="flex-align gap-8">
                                    <span class="h6 mb-0 fw-medium text-gray-300">{{ $categoria->nombre }}</span>
                                </div>
                            </td>
                            <td>
                                <div class="flex-align gap-8">
                                    <span class="h6 mb-0 fw-medium text-gray-300">{{ $categoria->descripcion }}</span>
                                </div>
                            </td>
                            <td>
                                @php
                                    $estado = $categoria->eliminado ? 'eliminado' : $categoria->estado;
                                    $clases = match ($estado) {
                                ...
                                <div class="d-flex justify-content-start gap-2">
                                    @if ($categoria->eliminado)
                                        ...
                                        <a href="javascript:;"
                                            ...
                                            data-id="{{ $categoria->id }}" data-bs-toggle="modal"
                                        ...
                                        <a href="javascript:;"
                                            ...
                                            data-id="{{ $categoria->id }}" data-name="{{ $categoria->nombre }}" data-bs-toggle="modal"
...
@section('script')
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            const baseUrl = {!! json_encode(url('/categorias')) !!};
