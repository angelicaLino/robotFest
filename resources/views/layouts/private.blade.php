            ...
            <div class="flex-align gap-16">
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="p-24 max-h-270 overflow-y-auto scroll-sm">
                                        <div class="d-flex align-items-start gap-12">
                                            <img src="{{ asset('assets_private/images/thumbs/notification-img1.png') }}"
                                            ...
                                            <div class="border-bottom border-gray-100 mb-24 pb-24">
                                                ...
                                                <div class="flex-align gap-6 mt-8">
                                                    <img src="{{ asset('assets_private/images/icons/google-drive.png') }}"
                                                        alt="">
                                                    <div class="flex-align gap-4">
                                        ...
                                        <div class="d-flex align-items-start gap-12">
                                            <img src="{{ asset('assets_private/images/thumbs/notification-img2.png') }}"
                                                alt="" class="w-48 h-48 rounded-circle object-fit-cover">
                                            <div class="">
                                                <a href="#"
                ...
                <div class="dropdown">
                    <button
                        ...
                        type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="position-relative">
                            <img src="{{ asset('assets_private/images/thumbs/user-img.png') }}" alt="Image"
                        ...
                        <div class="card border border-gray-100 rounded-12 box-shadow-custom">
                            <div class="card-body">
                                <div class="flex-align gap-8 mb-20 pb-20 border-bottom border-gray-100">
                                    <img src="{{ asset('assets_private/images/thumbs/user-img.png') }}" alt=""
                                ...
                                <ul class="max-h-270 overflow-y-auto scroll-sm pe-4">
                                    ...
                                    <li class="pt-8 border-top border-gray-100">
                                        <form method="POST" action="{{ route('logout') }}">
                                            ...
                                            <button type="submit"
                                                class="py-12 text-15 px-20 hover-bg-danger-50 text-gray-300 hover-text-danger-600 rounded-8 flex-align gap-8 fw-medium text-15 w-100">
